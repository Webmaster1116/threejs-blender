...
export class Messenger {
  static readonly GlobalMessenger = new Messenger();
  ...
  static listenTo(message: string, callback: (e: any) => void) {
    this.GlobalMessenger.listenTo(message, callback);
  }
  ...
  /**
   * De-register callback(s) from being executed on the global messengers instance
   ...
   * @returns {Function}
   */
  _createListener(callback: (e: any) => void) {
    return (e: Event & { detail: string }) => {
      let value;
   ...
   * @returns {CustomEvent}
   */
  _createEvent(message: string, value?: any): CustomEvent {
   ...
   */
  _addListener(message: string, listener: (e: any) => void) {
   ...
   * @param {Function} listener - A listener function generated using _createListener.
   */
  _removeListener(message: string, listener: (e: any) => void) {

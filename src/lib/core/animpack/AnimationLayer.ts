...
export class AnimationLayer
  ...
  implements AnimationPlayerInterface, StateContainerInterface
{
  /**
   * @constructor
   *
   ...
   */
  getAnimationBlendNames(animationName: string) {
